    ...
    <div className="bg-background min-h-screen">
      ...
      <main className="pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="max-w-[1700px] mx-auto px-6 md:px-12 lg:px-16 w-full">
          ...
          <div className="mb-12 md:mb-16">
            ...
            >
              <ChevronLeft className="w-4 h-4 transition-transform group-hover:-translate-x-2" strokeWidth={1} />
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              <div className="relative group/main flex items-center justify-center min-h-[400px] lg:min-h-[600px] bg-foreground/[0.02] border border-foreground/[0.05]">
                  ...
                  <div className="absolute bottom-8 left-8 flex flex-col gap-1.5 opacity-10 pointer-events-none">
                    <span className="text-[7px] uppercase tracking-[.4em] font-bold">Otton Atelier</span>
                    <span className="text-[7px] uppercase tracking-[.4em] font-bold">Natural Formation</span>
                  </div>
              </div>
            </div>
              ...
              <div className="max-w-md space-y-12 md:space-y-16">
                <div className="space-y-8">
                  <div className="flex items-center gap-4">
                     ...
                     <span className="text-[9px] font-bold uppercase tracking-[.8em] text-muted-foreground">{product.subtitle}</span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-10 py-6 border-y border-foreground/5">
                  <div className="space-y-1.5">
                    <span className="text-[8px] uppercase tracking-[.4em] text-muted-foreground font-bold block">{t.products.ref}</span>
                    <span className="text-foreground/80 text-sm tracking-[.2em] font-light uppercase">OT-100{product.id.length}</span>
                  </div>
                  <div className="space-y-1.5">
                    <span className="text-[8px] uppercase tracking-[.4em] text-muted-foreground font-bold block">{t.products.status}</span>
                    <span className="text-foreground/80 text-sm tracking-[.2em] font-light uppercase">{t.products.exclusive}</span>
                  </div>
                </div>
                ...
                <div className="pt-10 space-y-6">
                  ...
                  <div className="flex items-center gap-4 p-4 bg-foreground/[0.03] border border-foreground/[0.05] rounded-sm animate-afi">
                    ...
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-[.2em] text-foreground">{product.name}</p>
                      <p className="text-[8px] uppercase tracking-[.1em] text-muted-foreground">Pronto para orçamento</p>
                    </div>
                  </div>
                  ...
                  >
                    <span className="relative z-10 transition-colors duration-700">{t.products.consultancy}</span>
                  ...
                  <p className="text-center mt-4 text-[8px] uppercase tracking-[.3em] text-muted-foreground">{t.products.whatsapp_text}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 md:py-40 border-t border-foreground/5 bg-foreground/[0.01]">
        <div className="max-w-[1700px] mx-auto px-6 md:px-12 lg:px-16">
          <h2 className="font-display text-3xl md:text-5xl text-foreground mb-12 md:mb-20 tracking-tighter italic">{t.products.related}</h2>
